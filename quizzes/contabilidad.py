...
QUESTIONS = {
    1: [
        q("¿Cómo define la contabilidad al concepto de 'ente'?",
          ...
          "El módulo define 'ente' como todo lo que es, existe o puede existir, distinguiendo personas humanas de personas jurídicas (organizaciones).",
          "easy"),
        q("¿Cuál es la diferencia entre organizaciones públicas y privadas?",
          ...
          "Las organizaciones públicas involucran participación estatal o brindan servicios sociales (dependen del Estado). Las privadas son formadas por personas para obtener un beneficio.",
          "easy"),
        q("¿Qué representa la ecuación contable ACTIVO = PASIVO + PATRIMONIO NETO?",
          ...
          "La ecuación muestra que todos los Recursos (Activo) están financiados por fuentes: Ajenas (Pasivo = deudas con terceros) o Propias (PN = aportes de los propietarios).",
          "easy"),
        q("¿Qué son las variaciones patrimoniales permutativas?",
          ...
          "Las variaciones permutativas modifican la composición del patrimonio pero no el monto total del PN. Ejemplos: depósito de efectivo en banco (+A; -A), pago a proveedor (-A; -P).",
          "medium"),
        q("Una empresa paga un servicio de electricidad en efectivo. ¿Qué tipo de variación patrimonial genera?",
          ...
          "Es una variación modificativa: aumenta un Resultado Negativo (Gasto) y disminuye el Activo (Caja/Banco). Esto afecta el monto total del PN.",
          "medium"),
        q("¿Cuál es la diferencia entre 'ingresos' y 'ganancias' en el contexto del Patrimonio Neto?",
          ...
          "Los Ingresos son aumentos del PN por la actividad principal (ventas). Las Ganancias son aumentos del PN por operaciones secundarias o accesorias (ej: venta de un activo fijo con ganancia).",
          "hard"),
        q("¿En qué momento el Patrimonio Neto de un ente es igual al capital?",
          ...
          "Al inicio de la vida del ente, el Patrimonio Neto es igual al Capital aportado por los propietarios. Con el tiempo varía por resultados, nuevos aportes o retiros.",
          "medium"),
    ],
    2: [
        q("Según Fowler Newton, ¿cuál es la función principal de la Contabilidad?",
          ...
          "Según Fowler Newton, la Contabilidad procesa datos sobre el patrimonio del ente y contingencias, para producir información para la toma de decisiones de administradores y terceros.",
          "easy"),
        q("¿Qué diferencia hay entre la contabilidad para uso externo y para uso interno?",
          ...
          "La contabilidad externa informa a terceros (inversores, bancos, gobierno). La interna sirve para que la dirección fije políticas, evalúe la gestión y controle presupuestos.",
          "easy"),
        q("¿Qué tipo de información contable se produce cuando una empresa elabora proyecciones de ventas para el próximo año?",
          ...
          "Los presupuestos y proyecciones son información del futuro: el ente las utiliza para anticiparse y gestionar acciones (planes de inversión, proyecciones de ventas).",
          "medium"),
        q("¿Cuáles son los componentes de un Sistema Contable?",
          ...
          "El sistema contable se apoya en: medios de registración (documentos), cuentas, registros (libros), métodos de trabajo, archivos y normas contables.",
          "medium"),
        q("¿Para qué sirve la información contable para uso externo según el módulo?",
          ...
          "La contabilidad externa permite a posibles inversores, bancos, el gobierno, proveedores y clientes evaluar la situación económica y financiera del ente.",
          "easy"),
    ],
    3: [
        q("¿Cuáles son los cuatro Estados Contables Básicos?",
          ...
          "Los 4 estados básicos obligatorios son: 1) Estado de Situación Patrimonial, 2) Estado de Resultados, 3) Estado de Evolución del PN y 4) Estado de Flujo de Efectivo.",
          "easy"),
        q("¿Qué principio contable establece que se asume que el ente tiene continuidad futura y no se espera su liquidación?",
          ...
          "El principio de Empresa en Marcha (Continuidad) asume que el ente tiene existencia continua y proyección futura, sin liquidación a corto plazo.",
          "easy"),
        q("¿Qué diferencia hay entre informes contables puros y de gestión?",
          ...
          "Los informes puros (estados contables) son obligatorios y para uso externo. Los informes de gestión se elaboran según necesidades internas para la dirección.",
          "medium"),
        q("¿Qué establece el principio contable del Devengado?",
          ...
          "El principio del Devengado establece que los resultados se reconocen cuando ocurre el hecho generador, independientemente del cobro o pago.",
          "medium"),
        q("¿Cuál es la diferencia entre un Estado Contable estático y uno evolutivo?",
          ...
          "El Estado de Situación Patrimonial es estático (fotografía de un momento). Los estados evolutivos (Resultados, Evolución del PN, Flujo de Efectivo) muestran cambios durante un período.",
          "medium"),
        q("¿Por qué el principio de Realización complementa al principio del Devengado?",
          ...
          "El Devengado indica que el resultado se reconoce cuando ocurre el hecho. La Realización complementa indicando que el hecho debe estar 'perfeccionado' (completado y sus riesgos evaluados).",
          "hard"),
    ],
    4: [
        q("¿Cuál es el saldo habitual de una cuenta de Activo y cómo se incrementa?",
          ...
          "Las cuentas de Activo tienen saldo deudor habitual y se incrementan debitando (anotando en el Debe). Disminuyen acreditando (anotando en el Haber).",
          "easy"),
        q("¿Qué es el Plan de Cuentas?",
          ...
          "El Plan de Cuentas es el conjunto ordenado y codificado de cuentas disponibles para el ente. Sirve como estructura central del sistema contable. El Manual de Cuentas lo complementa con descripción detallada.",
          "easy"),
        q("¿Qué distingue a las cuentas cancelables de las permanentes?",
          ...
          "Las cuentas cancelables (resultados y de movimiento) transfieren su saldo al cierre y quedan en cero. Las permanentes (patrimoniales) mantienen su saldo al inicio del siguiente ejercicio.",
          "medium"),
        q("¿Cuál es el principio fundamental de la Partida Doble?",
          ...
          "El principio es 'No hay deudor sin acreedor'. Cada operación afecta al menos dos cuentas y la suma total de débitos siempre iguala la suma total de créditos.",
          "medium"),
        q("¿Qué es una cuenta regularizadora del activo y cuál es su ejemplo típico?",
          ...
          "Las cuentas regularizadoras del activo ajustan el valor contable de un activo restándole importes. 'Previsión para Deudores Incobrables' resta valor a 'Deudores por Ventas'. Tienen saldo acreedor.",
          "hard"),
        q("¿Cuál es la función del Libro Mayor en el sistema contable?",
          ...
          "El Libro Mayor registra los débitos y créditos de cada cuenta individualmente, permitiendo conocer el saldo de cualquier cuenta en cualquier momento.",
          "medium"),
    ],
    5: [
        q("¿Qué es el ciclo operativo de una empresa?",
          ...
          "El ciclo operativo es el día a día de la actividad principal: comprar, producir, vender, cobrar. Su duración puede ser mayor o menor que el ejercicio contable.",
          "easy"),
        q("¿Cuál es la secuencia correcta del ciclo contable?",
          ...
          "El ciclo contable sigue: Comprobante → Diario → Mayor → Balance de Saldos → Estados Contables. Es el proceso desde que nace una operación hasta los informes finales.",
          "easy"),
        q("¿Qué diferencia fundamental existe entre una S.A. y una S.R.L. en cuanto al capital?",
          ...
          "La S.A. divide el capital en acciones, puede tener socios ilimitados. La S.R.L. divide el capital en cuotas sociales y tiene un máximo de 50 socios. Ambas limitan la responsabilidad al aporte.",
          "medium"),
        q("¿Qué porcentaje mínimo de los aportes en efectivo debe integrarse al constituir una S.A. o S.R.L.?",
          ...
          "Tanto en S.A. como S.R.L., los aportes en efectivo deben integrarse al menos en un 25% al inicio, con un plazo máximo de 2 años para el saldo. La S.A.U. debe integrar el 100% desde el inicio.",
          "medium"),
        q("Al suscribir el capital de una S.A., ¿qué asiento contable se registra?",
          ...
          "En la suscripción de S.A.: se debita Accionistas (+A, compromiso de pago) y se acredita Acciones a emitir (+PN). Cuando integran: se debita Caja y se acredita Accionistas.",
          "hard"),
    ],
    6: [
        q("¿Cuándo se considera 'perfeccionada' una compra para registrarla contablemente?",
          ...
          "La compra se perfecciona (y debe registrarse) con la entrega física del bien. Para bienes registrables (inmuebles, vehículos), cuando se obtiene el título de propiedad.",
          "easy"),
        q("¿Qué documento respalda la entrega de mercaderías sin incluir importes monetarios?",
          ...
          "El remito respalda la entrega de mercaderías sin importes (solo cantidades). Una copia debe ser firmada por el receptor. El original es para el vendedor, el duplicado para el comprador.",
          "easy"),
        q("¿Qué incluye el valor de incorporación de un bien al patrimonio de la empresa?",
          ...
          "El valor de incorporación = precio de lista menos bonificaciones y descuentos de intereses, MÁS costos para tener el bien disponible (fletes, carga). Los intereses financieros NO forman parte.",
          "medium"),
        q("¿Cómo se calcula el Costo de Mercaderías Vendidas (CMV) con el método global?",
          ...
          "Con el método global (diferencia de inventarios): CMV = Existencia Inicial + Compras – Existencia Final. No detecta faltantes inmediatos. Se usa para bienes de alta rotación y escaso valor.",
          "medium"),
        q("¿Cuál es la diferencia entre una bonificación y un descuento por pronto pago en una venta?",
          ...
          "Las bonificaciones son descuentos comerciales (por volumen) que reducen el precio de venta neto. El descuento por pronto pago oculta un interés incluido en el precio: es un ingreso financiero, no comercial.",
          "hard"),
        q("Al vender mercaderías, ¿cuántos asientos contables se realizan y qué registra cada uno?",
          ...
          "Se hacen 2 asientos: 1) Registrar la venta (+A o +cobro; +Ventas). 2) Registrar el CMV (+Costo de Merc. Vendida resultado negativo; -Mercaderías activo). El beneficio surge de la diferencia.",
          "hard"),
    ],
    7: [
        q("¿Qué establece el principio del devengado para el registro contable de las operaciones?",
          ...
          "El principio del devengado establece que se registra cuando ocurre el hecho generador (nace el derecho o la obligación), no cuando hay movimiento de dinero.",
          "easy"),
        q("¿Cuál es la diferencia entre un 'ingreso' y una 'ganancia' como resultados positivos?",
          ...
          "Los Ingresos surgen de la actividad principal (producción, ventas, prestaciones). Las Ganancias surgen de operaciones secundarias/accesorias o circunstancias no vinculadas a la actividad principal.",
          "easy"),
        q("¿Qué distingue a un 'gasto' de una 'pérdida' como resultados negativos?",
          ...
          "Los Gastos se relacionan directamente con los ingresos de la actividad principal (CMV, gastos de administración). Las Pérdidas no están relacionadas con ingresos (siniestros, gastos de juicio).",
          "medium"),
        q("¿Qué diferencia hay entre un hecho económico y un hecho financiero?",
          ...
          "El hecho económico modifica el PN (genera resultados). El hecho financiero implica movimiento de dinero (cobros/pagos). Una venta a crédito es económica; cobrar esa venta es financiero.",
          "medium"),
        q("El pago de un anticipo por mercaderías que aún no se recibieron, ¿qué tipo de variación patrimonial es?",
          ...
          "El anticipo es un hecho financiero (egreso de dinero) que genera un derecho (activo). No es un gasto porque el bien/servicio aún no fue recibido. Es permutativo: -A (Caja); +A (Anticipo).",
          "hard"),
        q("Si una empresa recibe una boleta de luz pero aún no la paga, ¿cómo debe registrarla?",
          ...
          "Por el principio del devengado: el consumo de energía ya ocurrió. Debe registrarse el gasto (resultado negativo) y la deuda (pasivo), aunque no haya habido pago.",
          "medium"),
    ],
    0: [
        q("¿Cuál es la relación entre el principio del Devengado y la Igualdad Contable Dinámica?",
          ...
          "La igualdad dinámica expande la estática para mostrar resultados: A + G.neg + P.neg = P + Capital + G.pos + I. El devengado determina cuándo se reconocen esos resultados.",
          "hard"),
        q("¿Qué información tiene en común el Estado de Situación Patrimonial con la ecuación A = P + PN?",
          ...
          "El Estado de Situación Patrimonial (Balance) es la 'foto' del ente en un momento: muestra el Activo, Pasivo y PN, verificando la ecuación fundamental A = P + PN.",
          "medium"),
        q("¿En qué se diferencia el ciclo contable del ciclo operativo en su punto de partida?",
          ...
          "El ciclo contable se activa cuando una operación entra al sistema contable (comprobante→Diario→Mayor→EC). El ciclo operativo es la realidad del negocio: comprar, producir, vender, cobrar.",
          "medium"),
        q("¿Por qué los intereses de una compra a crédito NO forman parte del valor de incorporación de la mercadería?",
          ...
          "El valor de incorporación incluye el precio neto MÁS costos necesarios para tener el bien disponible. Los intereses son un costo financiero (Resultado Negativo) separado, no parte del valor del bien.",
          "hard"),
        q("Si una empresa realiza una venta a crédito, ¿cuántos hechos económicos y financieros se producen?",
          ...
          "La venta es un hecho económico (genera ingreso, modifica el PN). El cobro posterior es un hecho financiero (movimiento de dinero). Son dos eventos distintos reconocidos por el devengado.",
          "hard"),
        q("¿Qué principio contable justifica que las mercaderías en stock figuren como activo y no como gasto?",
          ...
          "Las mercaderías son un Costo no Consumido: están en el activo porque se relacionan con ingresos FUTUROS. Cuando se venden, el costo se 'consume' y pasa a ser CMV (resultado negativo).",
          "hard"),
        q("¿Cómo se relacionan el Plan de Cuentas con los Estados Contables?",
          ...
          "El Plan de Cuentas estructura las cuentas del sistema contable. Los saldos de esas cuentas (obtenidos en el Mayor y el Balance de Sumas y Saldos) son la materia prima para elaborar los Estados Contables.",
          "medium"),
        q("¿Qué tienen en común las cuentas 'cancelables' con los 'informes de gestión'?",
          ...
          "Las cuentas cancelables (resultados) transfieren su saldo y quedan en cero al cierre. Los informes de gestión son renovados para cada período. Ambos son 'temporales' por naturaleza.",
          "hard"),
    ],
}
